...
public class ClientLengthFrame extends JFrame {
	...
	private JLabel lblServerSentence;
	...
	public ClientLengthFrame () {
		...
		lblServerSentence = new JLabel("-");
		lblServerSentence.setBounds(282, 38, 394, 39);
	 ...
	 */
	public void updateServerSentence (String sentence) {
		
		this.lblServerSentence.setText(sentence);
	...
	private JPanel getServerDatePanel(Font font) {
		...
		JPanel panel = new JPanel();
		JLabel lblSentence = new JLabel ("Sentence from Server: ");
		lblSentence.setBounds(10, 38, 269, 39);

		// Style the component
		lblSentence.setFont(font);
		lblServerSentence.setFont(font);
		lblSentence.setBackground(Color.WHITE);
		lblSentence.setOpaque(true);
		lblServerSentence.setBackground(Color.WHITE);
		lblServerSentence.setOpaque(true);
		panel.setLayout(null);

		// Organize components into panel
		panel.add(lblSentence);
		panel.add(lblServerSentence);
