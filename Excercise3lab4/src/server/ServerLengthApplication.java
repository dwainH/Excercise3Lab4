 ...
 * 
 * @author dwainhanlonmatin
 *
 */

public class ServerLengthApplication {
	...
	public static void main(String[] args) throws IOException {
		...
		ServerLengthFrame serverFrame = new ServerLengthFrame();
		...
		while (true) {
			...
			String currentSentence = lengthGenerator.getCurrentSentence();
			
			// Create stream to write data on the network
			DataOutputStream outputStream = 
					new DataOutputStream(clientSocket.getOutputStream());
			
			// Send current sentence back to the client
			outputStream.writeBytes(currentSentence);
			...
			serverFrame.updateRequestStatus(
					"Sentence sent to the client: " + currentSentence);
